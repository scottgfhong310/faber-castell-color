...
I18n.register('ja', {
  ...
  'sets.baseline': 'すでに持っているもの',
  'setlist.title': 'シリーズとセットを選ぶ',
  'setlist.pickSeries': 'シリーズ',
  'setlist.pickOwned': 'すでに持っているセット',
  'setlist.ownedHint': '1 つ選ぶと、他のセットに「あと何色増えるか」が表示されます。もう一度クリックで解除。',
  'setlist.none': '（未選択・収録のみ表示）',

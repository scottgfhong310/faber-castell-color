...
- **セット収録対照ページ**（`sets.html`）— 逆方向。公式カラーチャートに倣った色 × セットの一覧表で、シリーズごとに 1 つの表。すでに持っているセットを選ぶと、他の列に「あと何色増えるか」が表示されます（例：Black Edition 100 色を持っているなら *skin tones* は 6 色、*metallic* は 12 色）。2 ページは相互にリンクします。
